...
@section('page-title', 'Manajemen - Edit Obat')
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bi bi-capsule"></i> Form Edit Data Obat</h5>
        <a href="{{ route('manajemen.obat') }}" class="btn btn-secondary btn-sm">
            <i class="bi bi-arrow-left"></i> Kembali
        </a>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('manajemen.obat.update', $id) }}">
            @csrf
            @method('PUT')
