...
@section('page-title', 'Manajemen - Edit Pasien')
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bi bi-people"></i> Form Edit Data Pasien</h5>
        <a href="{{ route('manajemen.pasien') }}" class="btn btn-secondary btn-sm">
            <i class="bi bi-arrow-left"></i> Kembali
        </a>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('manajemen.pasien.update', $id) }}">
            @csrf
            @method('PUT')
