...
@section('page-title', 'Manajemen - Tambah Petugas')
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bi bi-person-badge"></i> Form Data Petugas Baru</h5>
        <a href="{{ route('manajemen.petugas') }}" class="btn btn-secondary btn-sm">
            <i class="bi bi-arrow-left"></i> Kembali
        </a>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('manajemen.petugas.store') }}">
            @csrf
