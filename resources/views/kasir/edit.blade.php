...
@section('title', 'Edit Transaksi Kasir')
@section('page-title', 'Edit Transaksi Kasir')
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bi bi-cash-register"></i> Form Edit Transaksi Kasir</h5>
        <a href="{{ route('kasir.index') }}" class="btn btn-secondary btn-sm">
            <i class="bi bi-arrow-left"></i> Kembali
        </a>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('kasir.update', $id) }}">
            @csrf
            @method('PUT')
