...
@section('title', 'Edit IGD')
@section('page-title', 'Edit IGD')
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bi bi-heart-pulse"></i> Form Edit Pasien IGD</h5>
        <a href="{{ route('igd.index') }}" class="btn btn-secondary btn-sm">
            <i class="bi bi-arrow-left"></i> Kembali
        </a>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('igd.update', $id) }}">
            @csrf
            @method('PUT')
