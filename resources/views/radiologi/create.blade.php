...
@section('title', 'Tambah Pemeriksaan Radiologi')
@section('page-title', 'Tambah Pemeriksaan Radiologi')
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bi bi-radar"></i> Form Pemeriksaan Radiologi Baru</h5>
        <a href="{{ route('radiologi.index') }}" class="btn btn-secondary btn-sm">
            <i class="bi bi-arrow-left"></i> Kembali
        </a>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('radiologi.store') }}">
            @csrf
